...
<html lang="fa" dir="rtl">
    ...
    <body class="min-h-screen bg-[#f7f7f5] text-zinc-900 antialiased transition-colors dark:bg-zinc-950 dark:text-zinc-100">
        <div
            ...
            class="mx-auto flex h-dvh max-w-7xl overflow-hidden bg-white shadow-[0_0_60px_rgba(24,24,27,0.06)] transition-colors dark:bg-zinc-900 dark:shadow-[0_0_60px_rgba(0,0,0,0.25)]"
        >
                    ...
                    @foreach ($conversations as $conversation)
                        ...
                        >
                            ...
                            <span class="min-w-0 flex-1">
                                ...
                                <time class="mt-0.5 block text-[10px] text-zinc-400 dark:text-zinc-500">{{ $conversation->updated_at->format('Y/m/d') }}</time>
                            </span>
                        </button>
                    @endforeach
                </nav>
            ...
            <main class="flex min-w-0 flex-1 flex-col">
                <header class="flex h-18 shrink-0 items-center justify-between border-b border-zinc-200/80 px-4 transition-colors dark:border-zinc-800 sm:px-7">
                    <div class="flex min-w-0 items-center gap-3">
                        ...
                        <div class="min-w-0">
                            <h1 data-current-title class="truncate text-sm font-bold tracking-tight sm:text-base">گفت‌وگوی تازه</h1>
        ...
        <template data-conversation-template>
            <button data-conversation-item type="button" class="group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-right transition hover:bg-white dark:hover:bg-zinc-900">
